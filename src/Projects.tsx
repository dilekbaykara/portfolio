      ...
      <div id="project-div-1">
        <div className="project-divs">
          ...
          <div className="project-title-div">
            <div className="project-title">eBird App</div>
            <div className="project-icon-div">
              <a
                id="github-icon"
                className="project-icon"
                href="https://github.com/dilekbaykara/bird-crawler"
                color="currentColor"
              >
                <svg
              ...
              <a
                id="www-icon"
                href="https://dilekbaykara.github.io/bird-crawler/"
              >
                <svg
                  id="www-icon"
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="project-description">
            ...
            checklist pages. Map data is then extracted and concatenated into a
            large map on an HTML page.
          </div>
        </div>
